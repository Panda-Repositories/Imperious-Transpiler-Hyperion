...
// Dumping Date: Wed Jun 23 19:03:14 2021
...
#define luaf_newcclosure_CCV __cdecl
	...
	static constexpr std::uintptr_t luaf_newlclosure_addr = 0x01600080;
...
#define luag_typeerror_CCV __cdecl
	...
	static constexpr std::uintptr_t luah_clone_addr = 0x015FE9B0;
...
#define luah_getstr_CCV __cdecl
	...
	static constexpr std::uintptr_t luah_new_addr = 0x015FEE00;
...
#define sandboxthread_CCV __cdecl
	...
	static constexpr std::uintptr_t setarrayvector_addr = 0x015FFA20;
#define setarrayvector_CCV __cdecl

	static constexpr std::uintptr_t setnodevector_addr = 0x015FFAC0;
...
#define vm_invoker_CCV __thiscall
	...
	static constexpr int ls_gs_rootgc = 32;
